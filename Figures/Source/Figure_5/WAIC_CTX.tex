...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot[style={black,fill=pastelpink,mark=none}] coordinates {(1,50.1)};
        \addplot[style={black,fill=pastelmagenta,mark=none}] coordinates {(1.5,38.1)};
        \addplot[style={black,fill=pastelred,mark=none}] coordinates {(2,30)};
        \addplot[style={black,fill=red,mark=none}] coordinates {(2.5,20.3)};
    \end{axis}
\end{tikzpicture}
\end{document}
