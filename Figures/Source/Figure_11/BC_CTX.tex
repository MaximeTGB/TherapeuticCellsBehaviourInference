...
\begin{tikzpicture}
    ...
    \addplot[color=black,mark size=3pt, mark=*,error bars/.cd,y dir=both,y explicit, error bar style={ultra thick}] coordinates {(0.1,-0.02)+- (0,0.09)};
    ...
    \addplot[color=black,mark=*,mark size=3pt, error bars/.cd,y dir=both,y explicit, error bar style={ultra thick}] coordinates {(2.05,-0.61)+- (0,0.034)};%\addlegendentry{$D_{m,\text{ox}}$}
